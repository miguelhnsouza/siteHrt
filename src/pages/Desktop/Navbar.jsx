...
import logoHrt from "@/assets/logo-hrt.png";
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav mb-2 mb-lg-0">
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="empreendDropdown">
                <li>
                  <a className="dropdown-item" href="#grand-hill">
                    Grand Hill
                  </a>
                </li>
                <li>
                  <a className="dropdown-item" href="#portal-do-lago">
                    Portal do Lago
                  </a>
                </li>
              </ul>
